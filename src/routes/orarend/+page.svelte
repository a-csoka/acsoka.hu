    ...
    <div class="relative flex-col w-full h-full">
        ...
        <div class="w-full h-full">
            {#each classes as element, Index}
                <div class="absolute hidden md:block w-[20%] rounded-xl bg-[#009db4] border border-[#006b82] " style="height: {element.Height}; left: {(element.Day-1)*20}%; top: {(element.StartTime-480)/60*6+4.5}rem;">
                ...
                <div class="absolute {(element.Day == currentDay ? "block" : "hidden")} md:hidden w-[100%] rounded-xl bg-[#009db4] border border-[#006b82] " style="height: {element.Height}; top: {(element.StartTime-480)/60*6+4.5}rem;">
                    <div class="text-center font-Gilmer text-lg font-bold mt-2">{element.Name}</div>
                    <div class="text-center font-Gilmer">{element.Classroom}</div>
                    <div class="text-center font-Gilmer">{element.TimeText}</div>
                </div>
